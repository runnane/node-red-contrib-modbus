...
de.biancoroyal.modbus.core.server.isValidMemoryMessage = function (msg) {
  return msg.payload && msg.payload.register && Number.isInteger(msg.payload.address) && msg.payload.address >= 0 && msg.payload.address <= 65535;
};
...
de.biancoroyal.modbus.core.server.writeModbusFlexServerMemory = function (node, msg) {
  var coreServer = de.biancoroyal.modbus.core.server;
